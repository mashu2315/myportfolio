const projects = [
  {
    id: 1,
    title: "Chat App - Talkyy",
    description: "A chat application that enables users to connect seamlessly with friends through instant messaging.",
  ...
  },
  {
    ...
    title: "Shop Me",
    description:
      "An e-commerce platform for clothing and accessories, enabling users to shop for themselves and friends.",
  ...
  },
  {
    ...
    title: "Trend Wise",
    description:
      "Find popular trending topics or search any topic.",
  ...
  },
  {
    ...
    title: "Book Your Lab",
    description:
      "Book Your Lab is a healthcare platform that helps users identify medical issues, provides possible solutions, and offers online check-up services.",
  ...
  },
   {
    ...
    description:
      "Clone of a popular educational platform WS Cube Tech Clone",
  ...
  },
   {
    ...
    title: "Top Courses",
    description:
      "A basic course selection website where there are multiple courses.",
