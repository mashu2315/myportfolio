      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I'm passionate about the domain of web development and want to explore Data Structure and Algorithms and Competitive Programming. I'm constantly learning new technologies and
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                target="_blank"
                href="https://drive.google.com/file/d/1TI04NozWN_8P9RaRSAmNGKd3N8tDcc2d/view?usp=sharing"
